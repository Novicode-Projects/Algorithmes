const investment = (arr) => {
  ...
  return `Le meilleur coup à faire cette semaine était d'investir
  le ${weekDays[arr.indexOf(date[0])]} et de revendre le ${
    weekDays[arr.indexOf(date[1])]
  } pour un bénéfice de ${bestInvestment}.`;
};
